...
///	Type---MNEMONIC-----OPCODE------ADDRESING MODE----|---FLAGS----|---Comments------------------------------
	...
	**/
	...
	OPCODE EOR = 		0x5d;/*		Absolute,X		  |  -Z----N											*/	
	OPCODE EOR = 		0x59;/*		Absolute,Y		  |  -Z----N											*/	
	OPCODE EOR = 		0x45;/*		Zero Page		  |  -Z----N											*/	
	OPCODE EOR = 		0x55;/*		Zero Page,X		  |  -Z----N											*/	
	OPCODE EOR = 		0x41;/*		Indexed Indirect  |  -Z----N											*/	
	...
	**/
	OPCODE ROR = 		0x6a;/*		Accumulator		  |  CZ----N											*/	
	OPCODE ROR = 		0x7e;/*		Absolute		  |  CZ----N											*/	
	OPCODE ROR = 		0x6e;/*		Absolute,X		  |	 CZ----N											*/	
	OPCODE ROR = 		0x66;/*		Zero Page		  |  CZ----N											*/	
	OPCODE ROR = 		0x76;/*		Zero Page,X		  |	 CZ----N											*/
	/**
		Return functions
	*																										*/
	...
	**/
	OPCODE SBC = 		0xe9;/*		Immediate		  |  CZ---VN											*/	
	OPCODE SBC = 		0xed;/*		Absolute	      |	 CZ---VN											*/	
	OPCODE SBC = 		0xfd;/*		Absolute,X		  |  CZ---VN											*/	
	OPCODE SBC = 		0xf9;/*		Absolute,Y		  |  CZ---VN											*/	
	OPCODE SBC = 		0xe5;/*		Zero Page		  |  CZ---VN											*/	
	OPCODE SBC = 		0xf5;/*		Zero Page,X		  |  CZ---VN											*/	
	OPCODE SBC = 		0xe1;/*		Indexed Indirect  |  CZ---VN											*/	
	OPCODE SBC = 		0xf1;/*		Indirect Indexed  |  CZ---VN											*/	
	/**
		Set functions
	**/
	...
	*																										*/
	OPCODE STA = 		0x8d;/*		Absolute		  |  ------- 											*/	
	OPCODE STA = 		0x9d;/*		Absolute,X		  |  ------- 											*/	
	OPCODE STA = 		0x99;/*		Absolute,Y		  |  ------- 											*/	
	OPCODE STA = 		0x85;/*		Zero Page		  |  ------- 											*/	
	OPCODE STA = 		0x95;/*		Zero Page,X		  |  ------- 											*/	
	OPCODE STA = 		0x81;/*		Indexed Indirect  |  ------- 											*/	
	OPCODE STA = 		0x91;/*		Indirect Indexed  |  ------- 											*/	
	/**
		Store Index X in Memory
	*																										*/
	OPCODE STX = 		0x8e;/*		Absolute		  |  ------- 											*/	
	OPCODE STX = 		0x86;/*		Zero Page		  |  ------- 											*/	
	OPCODE STX = 		0x96;/*		Zero Page,Y		  |  -------											*/
	/**
		Sore Index Y in Memory
	*																										*/	
	OPCODE STY = 		0x8c;/*		Absolute		  |  -------											*/	
	OPCODE STY = 		0x84;/*		Zero Page		  |  ------- 											*/	
	OPCODE STY = 		0x94;/*		Zero Page,X		  |  ------- 											*/
	/***																									*/	
